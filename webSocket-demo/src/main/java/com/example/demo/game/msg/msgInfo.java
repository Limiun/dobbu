...
public final class msgInfo {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return msgInfo.internal_static_msg_Login_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return msgInfo.internal_static_msg_Login_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              msgInfo.Login.class, msgInfo.Login.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof msgInfo.Login)) {
        return super.equals(obj);
      }
      msgInfo.Login other = (msgInfo.Login) obj;
    ...
    public static msgInfo.Login parseFrom(
    ...
    public static msgInfo.Login parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static msgInfo.Login parseFrom(
    ...
    public static msgInfo.Login parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static msgInfo.Login parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static msgInfo.Login parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(msgInfo.Login prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.example.demo.game.msg.msgInfo.Login.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public msgInfo.Login getDefaultInstanceForType() {
        return msgInfo.Login.getDefaultInstance();
      }

      @java.lang.Override
      public msgInfo.Login build() {
        msgInfo.Login result = buildPartial();
      ...
      @java.lang.Override
      public msgInfo.Login buildPartial() {
        msgInfo.Login result = new msgInfo.Login(this);
        result.name_ = name_;
        result.pwd_ = pwd_;
        onBuilt();
        return result;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof msgInfo.Login) {
          return mergeFrom((msgInfo.Login)other);
        } else {
      ...
      public Builder mergeFrom(msgInfo.Login other) {
        if (other == msgInfo.Login.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        msgInfo.Login parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (msgInfo.Login) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final msgInfo.Login DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new msgInfo.Login();
    }

    public static msgInfo.Login getDefaultInstance() {
